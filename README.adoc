...
image:https://img.shields.io/maven-central/v/org.alexmond/yj-schema-validator.svg?label=Maven%20Central[Maven Central,link=https://search.maven.org/artifact/org.alexmond/yj-schema-validator]
...
image:https://img.shields.io/badge/docs-alexmond.org-blue[Documentation,link=https://www.alexmond.org/yj-schema-validator/current/]
image:https://img.shields.io/badge/changelog-{version}-blue[Changelog,link=https://www.alexmond.org/yj-schema-validator/current/CHANGELOG/]

image::sample.png[]

📖 *Documentation:* https://www.alexmond.org/yj-schema-validator/current/
...
----
- uses: alexmond/yj-schema-validator@{version}
  with:
