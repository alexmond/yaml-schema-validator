...
= YJ Schema Validator
:description: CLI to validate YAML and JSON against JSON Schema (Draft 2019-09 and 2020-12), with colored, JSON, JUnit, SARIF, or LLM-friendly output for CI pipelines.
